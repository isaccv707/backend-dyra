...
export const PERMISSIONS = [
  ...
  {
    action: 'device-catalog:update',
    description: 'Actualizar catálogo de equipos',
  },
  {
    action: 'device-catalog:delete',
  ...
  { action: 'devices:read', description: 'Leer equipos de inventario' },
  {
    ...
    description:
      'Actualizar equipos de inventario (incluye asignación y retiro)',
  },
  ...
  {
    action: 'price-sheets:update',
    description: 'Actualizar listas de precios',
  },
  ...
  {
    action: 'safeguards:update',
    description: 'Firmar resguardos y actualizar su documento firmado',
  },
  ...
  // Tickets
  {
    ...
    description:
      'Levantar tickets de soporte de TI y ver el histórico de los tickets propios',
  },
  {
  ...
  {
    action: 'vehicle-catalog:update',
    description: 'Actualizar catálogo de vehículos',
  },
  {
    action: 'vehicle-catalog:delete',
  ...
  { action: 'vehicles:read', description: 'Leer vehículos de inventario' },
  {
    ...
    description:
      'Actualizar vehículos de inventario (incluye asignación y retiro)',
  },
  {
  ...
  {
    action: 'vehicle-transfers:read',
    description: 'Leer transferencias de vehículos',
  },
  {
    action: 'vehicle-transfers:update',
    description:
  ...
  {
    action: 'vehicle-safeguards:read',
    description: 'Leer resguardos de vehículo',
  },
  {
    action: 'vehicle-safeguards:update',
    description:
      'Firmar resguardos de vehículo y actualizar su documento firmado',
  },
  {
    action: 'vehicle-safeguards:delete',
...
const USUARIO_PERMISSIONS = [
  ...PERMISSIONS.filter(
    (p) =>
      ...
      !USUARIO_EXCLUDED_MODULES.some((module) =>
...
export const ROLES = [
  {
    name: 'Administrador',
    description:
      'Acceso total: crear, leer, actualizar y eliminar en todos los módulos',
    permissions: PERMISSIONS.map((p) => p.action),
  },
  {
    name: 'Usuario',
    description:
      'Acceso de solo lectura en todos los módulos (excepto usuarios, roles y permisos), más poder levantar tickets de soporte de TI y ver su propio histórico',
    permissions: USUARIO_PERMISSIONS,
  },
  {
    name: 'Soporte TI',
    description:
      'Acceso de solo lectura en todos los módulos (excepto usuarios, roles y permisos), más la gestión de tickets de soporte de TI: ' +
      'crear tickets, ver todos los tickets de sus sucursales, cambiar estado/prioridad, asignar tickets y unirse a la sala de tiempo real de TI',
    permissions: [...USUARIO_PERMISSIONS, 'tickets:update'],
  },
];
