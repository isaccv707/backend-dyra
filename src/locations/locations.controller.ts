...
export class LocationsController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea un nuevo lugar físico (laboratorio, call center, etc.) dentro de una sucursal.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve las ubicaciones, con alcance según la sucursal del usuario autenticado.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Devuelve una ubicación por su identificador.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Elimina una ubicación existente. Los equipos que tenía asignados quedan disponibles.',
  })
  @ApiParam({ name: 'id', description: 'Identificador de la ubicación.' })
  @ApiResponse({
    status: 200,
