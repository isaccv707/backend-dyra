...
export class RolesController {
  ...
  @ApiOperation({
    summary: 'Crear rol',
    description: 'Crea un nuevo rol con su conjunto de permisos.',
  })
  ...
  @ApiOperation({
    summary: 'Obtener rol',
    description: 'Devuelve un rol por su identificador.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Actualiza los datos y permisos de un rol existente.',
  })
  @ApiParam({ name: 'id', description: 'Identificador del rol.' })
